 ...
 */
pub trait RelationTupleVisitor<'input>:
    ParseTreeVisitor<'input, RelationTupleParserContextType>
{
    /**
...
pub trait RelationTupleVisitorCompat<'input>:
    ParseTreeVisitorCompat<'input, Node = RelationTupleParserContextType>
{
    /**
     * Visit a parse tree produced by {@link RelationTupleParser#relationTuple}.
     * @param ctx the parse tree
