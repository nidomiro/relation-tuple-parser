...
type BaseParserType<'input, I> = BaseParser<
    'input,
    RelationTupleParserExt<'input>,
    I,
    RelationTupleParserContextType,
    dyn RelationTupleListener<'input> + 'input,
>;

type TokenType<'input> = <LocalTokenFactory<'input> as TokenFactory<'input>>::Tok;
pub type LocalTokenFactory<'input> = CommonTokenFactory;

pub type RelationTupleTreeWalker<'input, 'a> = ParseTreeWalker<
    'input,
    'a,
    RelationTupleParserContextType,
    dyn RelationTupleListener<'input> + 'a,
>;
...
impl<'input, I>
    RelationTupleParser<'input, I, DefaultErrorStrategy<'input, RelationTupleParserContextType>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>,
{
...
pub trait RelationTupleParserContext<'input>: for<'x> Listenable<dyn RelationTupleListener<'input> + 'x>
...
impl<'input> RelationTupleParserContext<'input>
    for TerminalNode<'input, RelationTupleParserContextType>
{
}
impl<'input> RelationTupleParserContext<'input>
    for ErrorNode<'input, RelationTupleParserContextType>
{
}
...
impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    ParserRecog<'input, BaseParserType<'input, I>> for RelationTupleParserExt<'input>
{
}

impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    Actions<'input, BaseParserType<'input, I>> for RelationTupleParserExt<'input>
{
...
pub type RelationTupleContext<'input> =
    BaseParserRuleContext<'input, RelationTupleContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn RelationTupleListener<'input> + 'a>
    for RelationTupleContext<'input>
{
...
impl<'input> RelationTupleContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn RelationTupleParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<RelationTupleContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            RelationTupleContextExt {
                relation: None,
                ph: PhantomData,
            },
        ))
...
pub trait RelationTupleContextAttrs<'input>:
    RelationTupleParserContext<'input> + BorrowMut<RelationTupleContextExt<'input>>
{
    fn namespacedObject(&self) -> Option<Rc<NamespacedObjectContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn subject(&self) -> Option<Rc<SubjectContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn EOF(&self) -> Option<Rc<TerminalNode<'input, RelationTupleParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn STRING(&self) -> Option<Rc<TerminalNode<'input, RelationTupleParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn relationTuple(&mut self) -> Result<Rc<RelationTupleContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            RelationTupleContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 0, RULE_relationTuple);
...
pub type NamespacedObjectContext<'input> =
    BaseParserRuleContext<'input, NamespacedObjectContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn RelationTupleListener<'input> + 'a>
    for NamespacedObjectContext<'input>
{
    fn enter(&self, listener: &mut (dyn RelationTupleListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input, 'a> Visitable<dyn RelationTupleVisitor<'input> + 'a>
    for NamespacedObjectContext<'input>
{
    fn accept(&self, visitor: &mut (dyn RelationTupleVisitor<'input> + 'a)) {
...
impl<'input> NamespacedObjectContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn RelationTupleParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<NamespacedObjectContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            NamespacedObjectContextExt {
                namespace: None,
                object: None,
                ph: PhantomData,
            },
...
pub trait NamespacedObjectContextAttrs<'input>:
    RelationTupleParserContext<'input> + BorrowMut<NamespacedObjectContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token STRING in current rule
    fn STRING_all(&self) -> Vec<Rc<TerminalNode<'input, RelationTupleParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn STRING(&self, i: usize) -> Option<Rc<TerminalNode<'input, RelationTupleParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn namespacedObject(
        &mut self,
    ) -> Result<Rc<NamespacedObjectContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            NamespacedObjectContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 2, RULE_namespacedObject);
        ...
        let result: Result<(), ANTLRError> = (|| {
            ...
            recog.base.enter_outer_alt(None, 1);
            {
                ...
                let tmp = recog.base.match_token(STRING, &mut recog.err_handler)?;
                cast_mut::<_, NamespacedObjectContext>(&mut _localctx).namespace =
                    Some(tmp.clone());
...
impl<'input> SubjectContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn RelationTupleParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<SubjectContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            SubjectContextExt { ph: PhantomData },
        ))
    }
}

pub trait SubjectContextAttrs<'input>:
    RelationTupleParserContext<'input> + BorrowMut<SubjectContextExt<'input>>
{
    fn subjectId(&self) -> Option<Rc<SubjectIdContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn subjectSet(&self) -> Option<Rc<SubjectSetContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn subject(&mut self) -> Result<Rc<SubjectContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> SubjectIdContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn RelationTupleParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<SubjectIdContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            SubjectIdContextExt { ph: PhantomData },
        ))
    }
}

pub trait SubjectIdContextAttrs<'input>:
    RelationTupleParserContext<'input> + BorrowMut<SubjectIdContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token STRING
    /// Returns `None` if there is no child corresponding to token STRING
    fn STRING(&self) -> Option<Rc<TerminalNode<'input, RelationTupleParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn subjectId(&mut self) -> Result<Rc<SubjectIdContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> SubjectSetContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn RelationTupleParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<SubjectSetContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            SubjectSetContextExt {
...
pub trait SubjectSetContextAttrs<'input>:
    RelationTupleParserContext<'input> + BorrowMut<SubjectSetContextExt<'input>>
{
    fn namespacedObject(&self) -> Option<Rc<NamespacedObjectContextAll<'input>>>
    where
        Self: Sized,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn subjectSet(&mut self) -> Result<Rc<SubjectSetContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
            ...
            match recog.interpreter.adaptive_predict(2, &mut recog.base)? {
                1 => {
                    ...
                    recog.base.enter_outer_alt(None, 1);
                    {
                        ...
                        cast_mut::<_, SubjectSetContext>(&mut _localctx).subjectNamespacedObject =
                            Some(tmp.clone());
                        ...
                        if _la == STRING {
                            {
                                ...
                                let tmp = recog.base.match_token(STRING, &mut recog.err_handler)?;
                                cast_mut::<_, SubjectSetContext>(&mut _localctx).subjectRelation =
                                    Some(tmp.clone());
                            }
                        }
                    }
