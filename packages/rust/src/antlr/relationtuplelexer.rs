...
impl<'input, Input:CharStream<From<'input> >> RelationTupleLexer<'input,Input> where &'input LocalTokenFactory<'input>:Default{
	pub fn new(input: Input) -> Self{
		RelationTupleLexer::new_with_token_factory(input, <&LocalTokenFactory<'input> as Default>::default())
	}
}
...
impl<'input, Input:CharStream<From<'input> >> Actions<'input,BaseLexer<'input,RelationTupleLexerActions,Input,LocalTokenFactory<'input>>> for RelationTupleLexerActions{
	}
...
impl<'input, Input:CharStream<From<'input> >> LexerRecog<'input,BaseLexer<'input,RelationTupleLexerActions,Input,LocalTokenFactory<'input>>> for RelationTupleLexerActions{
}
impl<'input> TokenAware<'input> for RelationTupleLexerActions{
	type TF = LocalTokenFactory<'input>;
}

impl<'input, Input:CharStream<From<'input> >> TokenSource<'input> for RelationTupleLexer<'input,Input>{
	type TF = LocalTokenFactory<'input>;
